...
const PaymentMethodList = () => {
  const { requestMethods } = useOnceOffEditPaymentContext();
  ...
  return (
    <div className="grid grid-cols-4 gap-4">
      ...
      >
        <div
          className={cn(
            "flex flex-col items-center justify-between gap-1 text-gray-400 transition-all duration-150 ease-in-out",
            {
