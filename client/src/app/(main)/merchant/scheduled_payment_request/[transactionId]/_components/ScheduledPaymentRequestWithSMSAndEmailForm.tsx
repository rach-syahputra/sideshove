...
import { scheduledPaymentRequestWithSMSAndEmailFormSchema } from "@/lib/validations/transaction";
...
const ScheduledPaymentRequestWithSMSAndEmailForm = () => {
  const router = useRouter();
  const { setStep, transaction } = useScheduledEditPaymentContext();

  const form = useForm<
    z.infer<typeof scheduledPaymentRequestWithSMSAndEmailFormSchema>
  >({
    resolver: zodResolver(scheduledPaymentRequestWithSMSAndEmailFormSchema),
    defaultValues: {
  ...
  const onSubmit = async (
    values: z.infer<typeof scheduledPaymentRequestWithSMSAndEmailFormSchema>,
  ) => {
...
export default ScheduledPaymentRequestWithSMSAndEmailForm;
